...
/**
 * this class represents the drawing area. it is backed by {@link Canvas} class. this class itself does not handle any of the drawing. this task is accomplished by the {@link AnimationTimer}.
 *
...
public class CanvasMap {
    ...
    /**
     * <p>
     * create a {@link Canvas} object call board. it provides the tools to draw in JavaFX. this is also a {@link Node} which means can be added to our JavaFX application. the object needed to draw on a {@link Canvas} is {@link GraphicsContext} which is retrieved using {@link Canvas#getGraphicsContext2D()} method.
     * </p>
     */
    private Canvas board;
    /**
     * create a {@link AbstractAnimator} called animator. {@link AnimationTimer} provides most common functionally needed to draw animations of ray casting.
     */
    ...
    /**
     * create a method called setAnimator. set an {@link AbstractAnimator}. if an animator exists {@link CanvasMap#stop()} it and call {@link CanvasMap#removeMouseEvents()}. then set the new animator and call {@link CanvasMap#start()} and {@link CanvasMap#registerMouseEvents()}.
     *
    ...
    /**
     * <p>
     * create a method called registerMouseEvents. register the mouse events for when the mouse is {@link MouseEvent#MOUSE_MOVED} or {@link MouseEvent#MOUSE_DRAGGED}.<br>
     * call {@link CanvasMap#addEventHandler} twice and pass to it {@link MouseEvent#MOUSE_DRAGGED}, {@link animator#mouseDragged} and {@link MouseEvent#MOUSE_MOVED}, {@link animator#mouseMoved}.</p>
     * <p>
     * a method can be passed directly as an argument if the method signature matches the functional interface. in this example you will pass the animator method using object::method syntax.</p>
     */
    ...
    /**
     * <p>
     * create a method called removeMouseEvents. remove the mouse events for when the mouse is {@link MouseEvent#MOUSE_MOVED} or {@link MouseEvent#MOUSE_DRAGGED}.<br>
     * call {@link CanvasMap#addEventHandler} twice and pass to it {@link MouseEvent#MOUSE_DRAGGED}, {@link animator#mouseDragged} and {@link MouseEvent#MOUSE_MOVED}, {@link animator#mouseMoved}.</p>
     * <p>
     * a method can be passed directly as an argument if the method signature matches the functional interface. in this example you will pass the animator method using object::method syntax.</p>
     */
    ...
    /**
     * create a method called start. start the animator. {@link AnimationTimer#start()}
     */
    public void start() {
        animator.start();
    }
    ...
    /**
     * create a method called gc. get the {@link GraphicsContext} of {@link Canvas} that allows direct drawing.
     *
    ...
    /**
     * create a method called w. get the height of the map, {@link Canvas#getHeight()}
     *
    ...
    public void addSampleShapes() {
        ...
        PolyShape p1 = new PolyShape().setPoints(60, 250, 120, 200, 200, 150, 200, 250, 100, 300);
        p1.setFill(Color.AQUAMARINE);
        p1.setWidth(2);
        p1.setStroke(Color.AZURE);
        shapes.add(p1);

        PolyShape p2 = new PolyShape().setPoints(500, 50, 600, 100, 550, 150, 450, 150, 450, 50);
        p2.setFill(Color.MEDIUMAQUAMARINE);
        p2.setWidth(2);
        p2.setStroke(Color.LIGHTYELLOW);
        shapes.add(p2);

        PolyShape p3 = new PolyShape().setPoints(70, 450, 170, 440, 220, 520, 85, 590, 40, 550);
        p3.setFill(Color.RED);
        p3.setWidth(2);
        p3.setStroke(Color.RED);
        shapes.add(p3);

        PolyShape p4 = new PolyShape().setPoints(470, 470, 610, 480, 600, 580, 460, 590, 420, 530);
        p4.setFill(Color.IVORY);
        p4.setWidth(2);
        p4.setStroke(Color.LEMONCHIFFON);
        shapes.add(p4);
